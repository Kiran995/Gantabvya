...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, AdapterView.OnItemSelectedListener, GoogleApiClient.ConnectionCallbacks,
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng kathmandu = new LatLng(27.700000, 85.333333);
        mMap.addMarker(new MarkerOptions().position(kathmandu).title("Kathmandu"));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(kathmandu, 16));
